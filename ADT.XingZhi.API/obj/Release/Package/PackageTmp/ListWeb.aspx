<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListWeb.aspx.cs" Inherits="ADT.XingZhi.API.ListWeb" %>
...
<head>
 ...
 -->
    ...
    <script type="text/javascript">
        $(function readyReg() {
            //获取li的个数
            var liLength = document.getElementById("WebList").getElementsByTagName('li').length;
        ...
        function LoadMore() {
            ...
            $.ajax({
                type: "get",
                dataType: "json",
                url: "API/GetList/GetListByWeb_Share?type=" + type + "&gender=" + gender + "&orderby=" + orderby + "&pagesize=" + pagesize + "&pageindex=" + pages + "&length=" + liLength,
                success: function (data) {
                    $("#WebList").append(data);
                    //获取已有的页数
                    var haspages = document.getElementById("WebList").getElementsByTagName('li').length
...
<body>
    ...
    <div class="container">
        <div class="ranking-list-con">
            <ul class="ranking-list" id="WebList">
                <%=LoadInfo() %>
            </ul>
