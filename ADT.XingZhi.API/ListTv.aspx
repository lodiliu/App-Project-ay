<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListTv.aspx.cs" Inherits="ADT.XingZhi.API.ListTv" %>
...
<head>
 ...
 -->
    ...
    <script type="text/javascript">
        ...
        $(function readyReg() {
            //获取li的个数
            var liLength = document.getElementById("TvList").getElementsByTagName('li').length;
        ...
        function LoadMore() {
            ...
            $.ajax({
                type: "get",
                dataType: "json",
                url: "API/GetList/GetListByTV_Share?type=" + type + "&gender=" + gender + "&pagesize=" + pagesize + "&pageindex=" + pages + "&length=" + liLength,
                success: function (data) {
                    $("#TvList").append(data);
                    //获取已有的页数
                    var haspages = document.getElementById("TvList").getElementsByTagName('li').length
...
<body>
    ...
    <div class="container">
        <div class="ranking-list-con">
            <ul class="ranking-list" id="TvList">
                <%=LoadInfo() %>
            </ul>
