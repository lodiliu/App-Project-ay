<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpinionList.aspx.cs" Inherits="ADT.XingZhi.FineManage.X.OpinionList" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" BoxFlex="1" PageSize="20" ShowBorder="false" ShowHeader="false"
            ...
            <Columns>
                ...
                <f:BoundField ExpandUnusedSpace="true" Width="150px" TextAlign="Center" DataField="opinion" HeaderText="反馈" />
                <f:BoundField Width="200px" TextAlign="Center" DataField="createdtime" HeaderText="创建时间" />
                <f:WindowField TextAlign="Center" HeaderText="查看" Title="查看详情" WindowID="Window1"
                    DataIFrameUrlFields="Id" DataIFrameUrlFormatString="ShowOpinion.aspx?id={0}"
                    Width="60px" Icon="UserGo" />
                <f:LinkButtonField CommandName="Delete" ConfirmText="反馈将会被删除，确定删除？" ConfirmIcon="Question"
