...
{
    public partial class FXHelpPage : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            try
            {
                StringBuilder condition = new StringBuilder(" where Type='FX' ");
        ...
        {
            int flag = operate.InsertHelpPage(this.txtHelpInfo.Text,"FX");
            if (flag >= 1)
            {
