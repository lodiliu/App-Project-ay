<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ADT.XingZhi.FineManage.S.U.Add" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="10px" ShowBorder="false" ShowHeader="false"
        ...
        <Toolbars>
            <f:Toolbar ID="Toolbar1" runat="server" ToolbarAlign="Center" Position="Bottom">
                <Items>
                    <f:Button ID="btnSave" Text="确定添加" ValidateForms="Form2,Form3" runat="server" OnClick="btnSave_Click"
                        ...
                        <Rows>
                            ...
                            <f:FormRow ColumnWidths="50% 50%">
                                <Items> 
                                    ...
                                    <f:Label ID="Label3" Text="注：初始口令可以设置->相关设置->安全配置->系统用户初始化口令" runat="server">
                                    </f:Label>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
    ...
    <f:Window ID="Window2" EnableIFrame="true" runat="server" EnableMaximize="true"
        EnableResize="true" Target="Top" IsModal="True" Width="260px" Height="500px"
        Hidden="true">
    </f:Window>
    </form>
</body>
