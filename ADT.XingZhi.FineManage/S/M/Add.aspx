<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ADT.XingZhi.FineManage.S.M.Add" %>

<!DOCTYPE html >
<html>
<head runat="server">
    <title>添加系统菜单信息</title> 
</head>
<body>
    <form id="form1" runat="server">
        <input id="txtId" type="hidden" value="0" runat="server" />
        ...
        <f:Form BodyPadding="10px" ID="Form2" EnableCollapse="true" runat="server" ShowHeader="false"
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server" ToolbarAlign="Center" Position="Bottom">
                    <Items>
                        <f:Button ID="btnSave" Text="保存并关闭" ValidateForms="Form2" runat="server" OnClick="btnSave_Click"
                            ValidateMessageBox="false">
                        </f:Button>
                        <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server">
                        </f:ToolbarSeparator>
                        <f:Button ID="btnSave2" Text="保存并继续" ValidateForms="Form2" runat="server" OnClick="btnSave2_Click"
                            ValidateMessageBox="false">
                        </f:Button>
                    </Items>
                </f:Toolbar>
