...
$(function () {
    ...
    uploader = WebUploader.create({
        ...
        // 文件接收服务端。
        server: '/Handler/ImgUp.ashx?nodedir=' + UPLOAD_DIR + '&key=' + UPLOAD_KEY + '&t=' + Math.random(),
        // 选择文件的按钮。可选。
...
function removePic(id) {
    ...
    $.post('/Handler/RemoveFile.ashx', { 'url': url, 'key': UPLOAD_KEY, 't': Math.random() }, function (respone) {
